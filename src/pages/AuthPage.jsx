          ...
          <div className="p-7">
            ...
            {mode === 'register' && step === 1 && (
              <form onSubmit={handleRegisterStep1} className="space-y-4">
                <div>
                  <label className="block text-xs font-medium text-[#4a4a3a] mb-1.5">Nama Lengkap</label>
                  <input
                    name="nama"
                    type="text"
                    value={form.nama}
                ...
                <div>
                  <label className="block text-xs font-medium text-[#4a4a3a] mb-1.5">Kota</label>
                  <select
                    name="kota"
                    value={form.kota}
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border border-[#e8e4db] bg-[#faf9f7] text-sm text-[#1a1a1a] focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/30 focus:border-[#2D6A4F] transition-all"
                  >
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-xl bg-[#2D6A4F] hover:bg-[#235c43] active:scale-[0.98] text-white text-sm font-semibold transition-all shadow-md shadow-[#2D6A4F]/20 mt-2"
                >
                  Lanjut →
                </button>
              </form>
