    ...
    <Layout>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-[#7a8a7a] mt-1">
          Pantau gizi balita wilayah {profile?.kota || 'kamu'}
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        <div className="bg-white rounded-2xl p-4 border border-[#e8e4db] text-center">
          ...
          <div className="text-xs text-[#9a9a8a] mt-1">Berisiko stunting</div>
        </div>
        <div className="bg-white rounded-2xl p-4 border border-[#e8e4db] text-center">
          <div className="text-2xl font-bold text-yellow-500">0</div>
          <div className="text-xs text-[#9a9a8a] mt-1">Perlu perhatian</div>
        </div>
      </div>
